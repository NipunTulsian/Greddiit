                            ...
                            <div className='LikeDislikeWrapper'>
                                <div className='LikeDislike'>
                                    <span style={{ border: "1px solid #fff", display: "flex", padding: "5px 10px", borderTopLeftRadius: "20px", borderBottomLeftRadius: "20px" }}>
                                        {liked < 1 && <AiOutlineLike size={20} id={"like" + props.id} style={{ marginRight: "2px", cursor: "pointer" }} onClick={likePost} />}
                                        {liked > 0 && <AiFillLike size={20} id={"like" + props.id} style={{ marginRight: "2px", cursor: "pointer" }} onClick={unlikePost} />}
